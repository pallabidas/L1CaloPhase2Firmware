...
GCTcard_t processInputLinks(ap_uint<576> link_in[N_INPUT_LINKS]){
...
// this is for testing pfcluster algo
...
//         cout << " here " << endl ;
    ...
    #pragma HLS unroll 
        ...
        #pragma HLS UNROLL
            ...
            //link_out[i].range(end, start) = Pfclusters.GCTpfclusters[i].et | ((ap_uint<24>) Pfclusters.GCTpfclusters[i].eta << 12 ) | ((ap_uint<24>) Pfclusters.GCTpfclusters[i].phi << 18) ;
            //cout << " " << Pfclusters.GCTpfclusters[i].et ;
        }
        //cout << "  " << endl ;
