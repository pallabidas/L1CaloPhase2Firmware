...
hgcaltp_t getPeakBin18N(const etaStrip_t& etaStrip){
...
hgcaltp_t bestOf18 = bestOf2(best0to15,best1617) ;

return bestOf18 ;
}

towerMax getPeakBin4N(const etaStripPeak_t& etaStrip){
#pragma HLS latency min=4
...
hgcaltp_t best4 = bestOf2(best01,best23) ;

        x.energy = bestOf4.energy ;
        x.etaMax = bestOf4.eta ;
        x.phiMax = bestOf4.phi ;
...
jetInfo getJetPosition(const hgcalRegion_t& hgcalRegion){
 #pragma HLS latency min=4
        ...
        jetInfo jet ;
                ...
                etaStripPeak.pk0 = getPeakBin18N(hgcalRegion.etaStrip0);
                etaStripPeak.pk1 = getPeakBin18N(hgcalRegion.etaStrip1);
                etaStripPeak.pk2 = getPeakBin18N(hgcalRegion.etaStrip2);
                etaStripPeak.pk3 = getPeakBin18N(hgcalRegion.etaStrip3);

        towerMax peakIn4;
        peakIn4 = getPeakBin4N(etaStripPeak);

        jet.seedEnergy = peakIn4.energy ;
        jet.energy = 0 ;
        jet.etaMax = peakIn4.etaMax ;
        jet.phiMax = peakIn4.phiMax ;
...
processInputLinks(link_in, HGCALRegion);
	...
	link_out[0] = 0;
        ...
        ap_uint<32> end = 33;
            ...
            link_out[0].range(end, start) = jet1 ;
